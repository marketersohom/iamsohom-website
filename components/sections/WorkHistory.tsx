...
const history = [
  ...
  },
  {
    ...
    location: "Mumbai",
    description:
      "Led international growth across South and Southeast Asia for a B2B SaaS platform. Built channel partnerships, scaled enterprise pipeline, and owned revenue targets across 6 markets.",
  },
  {
    period: "2016 – 2019",
    ...
    location: "Kolkata",
    description:
      "Built and scaled a performance-focused digital agency serving hospitality, retail, and healthcare clients across India. Led strategy, business development, and creative direction.",
  },
  {
    period: "2013 – 2016",
    ...
    description:
      "Managed distributor networks and field sales teams across a multi-state territory. Consistently delivered above-target revenue growth in competitive retail environments.",
  },
];
    ...
    <section id="history" className="py-16 border-t border-[#1e1e1e]">
      ...
      <div className="relative max-w-2xl">
        ...
        <div className="space-y-8">
          {history.map((item, i) => (
            <FadeUp key={item.period} delay={0.06 * i}>
              <div className="pl-8 relative">
                ...
                <p className="font-body text-[12px] text-gold/80 mb-2">{item.org}</p>
